...
void setLeverArm( real *leverArm )
{
    gAlgorithm.leverArmB[0] = leverArm[0];
    gAlgorithm.leverArmB[1] = leverArm[1];
    gAlgorithm.leverArmB[2] = leverArm[2];
}

void setPointOfInterest( real *pointOfInterest )
{
    gAlgorithm.pointOfInterestB[0] = pointOfInterest[0];
    gAlgorithm.pointOfInterestB[1] = pointOfInterest[1];
    gAlgorithm.pointOfInterestB[2] = pointOfInterest[2];
}